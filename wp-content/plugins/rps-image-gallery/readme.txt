...
* Optionally display EXIF data in the gallery and/or slideshow. (New in version 1.2.22)
* Optionally display gallery thumbnails as background images or standard images. (New in version 1.2.22)
...
* caption (default='false', allowed='false','caption','description') - show the image caption or description under the images in the gallery grid view.
...
* fb_title_show (default='true') - whether or not to show the caption or description under the images in the slideshow view.
* fb_title_position (default='over', allowed='over','outside','inside') - the position of the caption or description in relation to the image in the slideshow.
...
= What will display if I set caption to 'caption' or 'description' but some of my images don't have either? =
...
<code>
[gallery exif_locations=slideshow]
</code>
...
<code>
[gallery exif_locations=slideshow exif_fields=aperture,focal_length,iso,shutter_speed]
</code>
