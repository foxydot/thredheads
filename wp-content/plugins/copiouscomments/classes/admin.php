<?php
if ( !class_exists( "PluginBuddyCopiousComments_admin" ) ) {
    class PluginBuddyCopiousComments_admin {
	
		function PluginBuddyCopiousComments_admin(&$parent) {
			$this->_parent = &$parent;
	...
	$PluginBuddyCopiousComments_admin = new PluginBuddyCopiousComments_admin($this); // Create instance
}
