...
class WC_Gateway_Authorize_Net_SIM extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description = __( 'Accept credit card payments from customers through Authorize.net SIM', WC_Authorize_Net_AIM::TEXT_DOMAIN );
	...
	public function payment_fields() {
		...
		if ( $this->method_description ) {
			...
			echo '<p>' . wp_kses_post( $this->method_description ) . '</p>';
		}
		?>
		<fieldset>
