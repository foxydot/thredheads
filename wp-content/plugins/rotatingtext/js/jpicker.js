          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            expandableColorChanged =
              function(ui, context)
              {
                ...
                if (true == false) // (settings.window.bindToInput)
      ...
      color:
        {
          ...
          active: new Color({ ahex: '#D8D8D8ff' }), /* acceptable values are any declared $.jPicker.Color object or string HEX value (e.g. #ffc000) WITH OR WITHOUT the "#" prefix */
