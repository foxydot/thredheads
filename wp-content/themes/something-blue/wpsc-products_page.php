	...
	<?php if(wpsc_display_products()): ?>
		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			...
			<div class="default_product_display row product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?> group">
                    <div class="col-md-4"><?php if(wpsc_show_thumbnails()) :?>
                ...
                <?php endif; ?></div>
                    ...
                    <div class="col-md-8">
                        ...
                        <?php echo wpsc_product_rater(); ?>
                                <div class="button-wrapper">
                                    <a class="wpsc_product_title button" href="<?php echo esc_url( wpsc_the_product_permalink() ); ?>" title="<?php echo wpsc_the_product_title(); ?>">Take a Closer Look</a>
                                 </div>
